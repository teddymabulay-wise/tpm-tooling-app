...
export async function executeRow(
        ...
        suppliers: [
          {
            ...
            ...((supplier.addressStreet1 || supplier.city || supplier.countryIso2) && {
              address: {
                street1: supplier.addressStreet1 || '',
                street2: supplier.addressStreet2 || '',
                city: supplier.city || '',
                state: supplier.stateProvince || '',
                zipCode: supplier.postCode || '',
                country: supplier.countryIso2 || '',
              },
            }),
            customFields: {
              ...(supplier.brn && { 'corporate-registration-number': { value: supplier.brn } }),
              ...(supplier.materialityLevel && { 'materiality-level': { value: supplier.materialityLevel } }),
              ...(supplier.infosecCriticalityTier && { 'infosec-criticality-tier': { value: supplier.infosecCriticalityTier } }),
              ...(supplier.infosecSensitivityTier && { 'infosec-sensitivity-tier': { value: supplier.infosecSensitivityTier } }),
              ...(supplier.entityTypeCf && { 'entity-type': { value: supplier.entityTypeCf } }),
              ...(supplier.supportsCif && { 'supports-cif-1': { value: supplier.supportsCif } }),
              ...(supplier.nameOfParentEntity && { 'name-of-parent-entity': { value: supplier.nameOfParentEntity } }),
            },
          },
        ],
      },
  ...
  const bankRes = await makeOmneaRequest<unknown>(bankPath, {
    ...
    body: {
      ...
      address: {
        street1: bank.addressStreet1 || '',
        street2: '',
        city: bank.addressCity || '',
        state: '',
        zipCode: bank.addressZipCode || '',
        country: bank.addressCountry || '',
      },
    },
  });
